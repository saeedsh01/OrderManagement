...
namespace OrderManagement.Endpoints.API.Extentions
{
    public static class HostingExtensions
    {
        public static WebApplication ConfigureServices(this WebApplicationBuilder builder)
        {
            ...
            //zamin
            builder.Services.AddZaminApiCore("Zamin", "OrderManagement");
            ...
            //CommandDbContext
            builder.Services.AddDbContext<OrderManagementCommandDbContext>(c => c.UseSqlServer(configuration.GetConnectionString("CommandDb_ConnectionString"))
                .AddInterceptors(new SetPersianYeKeInterceptor(), new AddAuditDataInterceptor()));

            //QueryDbContext
            builder.Services.AddDbContext<OrderManagementQueryDbContext>(c => c.UseSqlServer(configuration.GetConnectionString("QueryDb_ConnectionString")));
